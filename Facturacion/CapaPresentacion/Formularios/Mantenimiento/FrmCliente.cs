...
namespace CapaPresentacion.Formularios.Mantenimiento
{
    public partial class FrmCliente : Form
    {
        ...
        {
            dataListado.Columns["PersonaNro"].HeaderText = "Codigo";
            for (int i = 0; i < dataListado.Columns.Count-1; i++)
            {
                dataListado.Columns[i].DefaultCellStyle.Alignment = DataGridViewContentAlignment.TopCenter;
            }
        ...
        {   
            try
            {
                ...
                if (Convert.ToInt32(cboTipoDocumento.SelectedValue) > 0)
                {
                    ...
                    tipoDocumento.Descripcion = cboTipoDocumento.Text;
                }                
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                this.cboTipoDocumento.SelectedValue = Convert.IsDBNull(this.dataListado.CurrentRow.Cells["NroTipoDocumento"].Value) ? 0: Convert.ToInt32(this.dataListado.CurrentRow.Cells["NroTipoDocumento"].Value);
