...
{
    public partial class FrmImpresionVentas : Form
    {
        public FrmImpresionVentas()
        {
            InitializeComponent();
            LlenarComboTipo();
        }
        ...
        private void FmImpresionVentas_Load(object sender, EventArgs e)
        {
        ...
        {
            FrmVentasFiltro frm = new FrmVentasFiltro();
