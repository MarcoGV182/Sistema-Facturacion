...
{
    public partial class FrmVistaPagoCP : Form
    {
        ...
        private void CrearTabla()
        {
            ...
            this.Dtdetalle.Columns.Add("ProveedorNro", System.Type.GetType("System.Int32"));
        ...
        public void ObtenerDatos(DateTime fecha,string cuentapagar,string factura, string proveedor, string nroproveedor, string saldo, string valorinicial) {
            this.txtfechacompra.Text = fecha.ToString("dd/MM/yyyy");
            this.txtcuentapagar.Text = cuentapagar;
            this.txtNroFactura.Text = factura;
            this.txtProveedorNro.Text = nroproveedor;
            this.txtNombre.Text = proveedor;
       ...
       private void FrmVistaPago_Load(object sender, EventArgs e)
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            try
           {
                ...
                else if((Convert.ToInt32(this.txtImportePago.Text) > Convert.ToDouble(this.txtSaldo.Text))  || Convert.ToInt32(this.txtImportePago.Text)==0) 
                {
                    ...
                    if (this.IsNuevo)
                    {
                        rpta = NPagoCuentaPorPagar.Insertar(Convert.ToInt32(this.txtcuentapagar.Text),this.dtpFechaPago.Value, Convert.ToInt32(this.cboFormaPago.SelectedValue),Convert.ToDecimal(this.txtImportePago.Text),txtObservacion.Text.Trim().ToUpper(),id);
        ...
        private void btnagregar_Click(object sender, EventArgs e)
        {
            ...
            row["ProveedorNro"] = Convert.ToInt32(txtProveedorNro.Text);
