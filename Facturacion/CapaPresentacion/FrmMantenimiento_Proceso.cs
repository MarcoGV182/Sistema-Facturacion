...
namespace CapaPresentacion
{
    public partial class FrmMantenimiento_Proceso : Form
    {
        ...
        {
            cboEmpleados.DataSource = NUsuarios.MostrarCombo();
            cboEmpleados.DisplayMember = "Usuario";
            cboEmpleados.ValueMember = "UsuarioNro";

            cboDescuento.DataSource = NDescuento.Mostrar();
            cboDescuento.DisplayMember = "Descripcion";
            cboDescuento.ValueMember = "DescuentoNro";

            cboUsuarioFiltro.DataSource = NUsuarios.MostrarCombo();
            cboUsuarioFiltro.DisplayMember = "Usuario";
            cboUsuarioFiltro.ValueMember = "UsuarioNro";
        }
