...
namespace CapaPresentacion
{
    public partial class FrmDescuento : Form
    {
        ...
        private static FrmDescuento _Instancia;
        public static FrmDescuento GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FrmDescuento();
            }
            return _Instancia;
        }
        ...
        {
            InitializeComponent();
            this.ttMensaje.SetToolTip(txtDescripcion, "Por favor ingrese la Descripcion");
        ...
        {
            this.dataListado.DataSource = NDescuento.Mostrar();
       ...
       /*private void Buscar()
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (opcion == DialogResult.OK)
                {
                    ...
                    {
                        this.MensajeError("El registro ya esta definido en un Usuario" +Environment.NewLine+ "(Tipo Usuario / Descuento)");
                    }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.txtDescripcion.Text == string.Empty)
                {
                    ...
                    errorIcono.SetError(txtDescripcion, "Ingrese el nombre del Descuento");
                }
                else
                {
                    ...
                    if (this.IsNuevo)
                    {
                        rpta = NDescuento.Insertar(this.txtDescripcion.Text.Trim().ToUpper());
                        //si se esta editando el registro    
                    }
                    else
                    {
                        rpta = NDescuento.Editar(Convert.ToInt32(this.txtCodigo.Text), this.txtDescripcion.Text.Trim().ToUpper());
                    }
                    if (rpta.Equals("OK"))
                    {
                        if (IsNuevo)
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                this.txtCodigo.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["DescuentoNro"].Value);
